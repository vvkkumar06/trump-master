...
const CardsGalleryView = (props) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView ref={galleryContainerRef}>
        <View style={{ flexDirection: 'row', flexWrap: 'wrap', rowGap: 5, columnGap: 5, overflow: 'visible', backgroundColor: 'transparent' }}>
          {dummyData.map(item => (
            ...
            >
              <GalleryItemComponent
                ...
                zIndexHandler={(z, id) => {
                  ...
                  galleryContainerRef.current.setNativeProps({
